...
paru -Syy ;paru -Syyu ;paru -Fy ; updatedb
echo

if ! command -v ansible &> /dev/null; then
    echo -e "${YELLOW}Installing Ansible.${NC}"

paru -S --noconfirm ansible-core
    echo
fi
...
paru -S --noconfirm antiword tesseract-ocr
    echo
fi
...
paru -S --noconfirm xml-twig-tools
    echo
fi
...
paru -S --noconfirm imagemagick libxext-dev xutils-dev
